...
class History {
    ...
    public function __construct(?int $id = null, ?int $wallet_id = null, ?float $nominal = null, ?string $history_name = null, ?string $history_category = null, ?string $create_time = null)
    {
        $this->id = $id;
